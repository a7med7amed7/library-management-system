 ...
 * /borrowers:
 *   get:
 *     summary: List all borrowers (Admin only)
 *     tags: [Borrowers]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 * /borrowers/{id}:
 *   get:
 *     summary: Get borrower by ID (Admin only)
 *     tags: [Borrowers]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get checked out books
 *     tags: [Borrowing]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of checked out books
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *               report_type:
 *                 type: string
 *                 enum: [borrowing, overdue, inventory, last_month_borrowing, last_month_overdue]
 *                 example: "borrowing"
 *               format:
 *                 type: string
 *                 enum: [xlsx, csv]
...
/**
 * @swagger
 * /reports/export/last-month-overdue:
 *   get:
 *     summary: Export last month's overdue books
 *     tags: [Reports]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: Overdue books export
 *         content:
 *           application/vnd.openxmlformats-officedocument.spreadsheetml.sheet:
 *             schema:
 *               type: string
...
/**
 * @swagger
 * /reports/export/last-month-borrowing:
 *   get:
 *     summary: Export last month's borrowing data
 *     tags: [Reports]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: Borrowing data export
 *         content:
 *           application/vnd.openxmlformats-officedocument.spreadsheetml.sheet:
 *             schema:
 *               type: string
...
// Export empty object to make this a valid JavaScript module
module.exports = {};